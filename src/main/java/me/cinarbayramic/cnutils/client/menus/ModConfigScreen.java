package me.cinarbayramic.cnutils.client.menus;
...
public class BetterDebugScreen extends Screen {
  public BetterDebugScreen() {
    super(Text.of("Configure Custom Debug INFO"));
  }
